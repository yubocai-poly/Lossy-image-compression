...
def ave_num(sum, w, h): 
    # We create the aux function here
    nodes = w * h
...
def DCT_Chen(A):
    """
    Here we combine the numbers with the same coefficient, therefore we have 352 multiplications in this algorithms,
    the count in the program calculate all the multiplication and in the test we find the result is exactly 352 times
    """
    C1 = zero_matrix(8, 8)
    count = 0
    C_8 = matrix(8)
